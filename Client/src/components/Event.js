				...
				<Box
					...
					>
						...
						<CardHeader
							...
							subheader={eventData.date + '  |  ' + eventData.time + '  |  ' + eventData.location}
							sx={{
						...
						<Grid container spacing={2}>
							<Grid item xs={12} sm={6}>
								...
								>
									...
									<CardMedia
										component='img'
										image={eventData.images[activeStep]}
										alt={eventData.images[activeStep]}
										style={{
											height: '300px',
											width: '100%',
											objectFit: 'cover',
									...
									<MobileStepper
										...
										nextButton={
											<Button
												size="small"
												onClick={handleNext}
												disabled={activeStep === eventData.images.length - 1}
											>
